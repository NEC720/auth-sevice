...
<head>
    ...
    <title>DossCopy Authantification Service</title>
                ...
                <svg id="a" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    ...
                    <defs>
                        <style>
                            ...
                            .r {
                                filter: url(#j);
                                font-family: Aclonica-Regular, Aclonica;
                                font-size: 31.76px;
                                letter-spacing: .04em;
                            }
                            ...
                            .s {
                                filter: url(#l);
                                font-family: TypoQuikThinDemo, Typo Quik Thin Demo;
                                font-size: 11.8px;
                            }
                        </style>
                        <linearGradient id="b" x1="102.1" y1="140.83" x2="236.29" y2="89.32"
                        ...
                        <linearGradient id="e" x1="39.61" y1="51.49" x2="195.05" y2="114.29"
                            gradientTransform="matrix(1, 0, 0, 1, 0, 0)" gradientUnits="userSpaceOnUse">
                    ...
                    <path class="n"
                        d="M164.17,45.98c-4.37,19.69-19.51,73.3-61.49,115.42-3.22,3.23-3.77,8.25-1.36,12.12l17.49,28.09c3.6,5.77,11.83,6.25,16.05,.92,17.5-22.09,56.01-77.38,71.19-152.46,1.23-6.09-3.44-11.78-9.65-11.78h-22.64c-4.61,0-8.6,3.2-9.6,7.7Z" />
                    <path class="q"
                        d="M205.55,44.01s10.74,30.51-61.14,19.45c-52.27-8.04-89.76-5.13-106.33-2.94-3.3,.44-4.56,4.57-2.05,6.76,4.66,4.07,9.94,10.46,10.7,18.94,.3,3.28,3.34,5.6,6.6,5.14l13.9-1.98-12.41,16.94c-1.68,2.29-1.74,5.4-.14,7.75l15.57,22.93c2.02,2.98,5.86,4.13,9.19,2.76,7.58-3.13,21.66-12.67,40.45-41.71,0,0,121.24,15.99,85.66-54.04Z" />
                    <ellipse class="o" cx="119.53" cy="40.34" rx="17.28" ry="11.6" /><text class="r"
                        transform="translate(29.97 173.15)">
                        <tspan x="0" y="0">ITH</tspan>
                    </text><text class="s" transform="translate(29.75 187.59)">
                        <tspan x="0" y="0">It </tspan>
                        <tspan class="p" x="9.57" y="0">T</tspan>
                        <tspan x="13.94" y="0">raining Hub</tspan>
                    </text>
                </svg>
            </div>

            <div class="mt-16">
                <div class="grid grid-cols-1 apidoc gap-6 lg:gap-8">
                    <a href=<?php echo env('API_URL') ?> class="scale-100 p-6 bg-white dark:bg-gray-800/50
                        dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset
                        dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex
                        ...
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">DossCopy service d'Authantification &
                                Documentation</h2>

                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                Bienvenue dans la documentation officielle de l'API DossCopy. Cette API est conçue pour
                                vous offrir une intégration
                                facile et fluide avec notre plateforme, vous permettant de tirer parti de toutes les
                                fonctionnalités que DossCopy a à
                                offrir.
                            </p>
                        </div>
